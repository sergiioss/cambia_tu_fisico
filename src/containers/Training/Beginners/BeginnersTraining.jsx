        ...
        <Container className="beginners-exercises-training">
            <Row className="first-section-beginners">
                <Col className="body-beginners-training" xs={12} sm={12} md={8} lg={8} xl={8} xxl={8}>
                    ...
                    <Image className="img-beginners" src="https://www.cambiatufisico.com/wp-content/uploads/musculacion5-696x392.jpg"></Image>
                    <section>
                        <p>
                        ...
                        <p>
                            En la actualidad, la práctica de la <strong>musculación</strong> es uno de los recursos más utilizados por todo tipo de personas ya sea para mejorar su físico, <a className="links-beginners" href="">ganar masa muscular</a>, <a className="links-beginners">perder peso</a> o simplemente como complemento para todo tipo de deportes.
                        </p>
                        <p>
                        ...
                        <Row className="square-beginners">
                            ...
                            <ul>
                                <li className="li-square-beginners">1 Los tres principios de la musculación</li>
