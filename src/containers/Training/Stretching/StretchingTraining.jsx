            ...
            <Row className="first-section-stretching">
                <Col className="body-stretching-training" xs={12} sm={12} md={8} lg={8} xl={8} xxl={8}>
                    ...
                    <section>
                        ...
                        <p>
                            En la actualidad, la práctica de la <strong>musculación</strong> es uno de los recursos más utilizados por todo tipo de personas ya sea para mejorar su físico, <a className="links-stretching" href="">ganar masa muscular</a>, <a className="links-stretching">perder peso</a> o simplemente como complemento para todo tipo de deportes.
                        </p>
                        <p>
                        ...
                        <Row className="square-stretching">
                            <p className="title-square-stretching">Contenidos</p>
                            <ul>
                                <li className="li-square-stretching">1 Los tres principios de la musculación</li>
