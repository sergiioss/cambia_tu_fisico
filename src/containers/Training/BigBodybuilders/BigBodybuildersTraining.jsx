        ...
        <Container className="big-body-builders-exercises-training">
            <Row className="first-section-big-body-builders">
                <Col className="body-big-body-builders-training" xs={12} sm={12} md={8} lg={8} xl={8} xxl={8}>
                    ...
                    <Image className="img-big-body-builders" src="https://www.cambiatufisico.com/wp-content/uploads/musculacion5-696x392.jpg"></Image>
                    <section>
                        <p>
                        ...
                        <p>
                            En la actualidad, la práctica de la <strong>musculación</strong> es uno de los recursos más utilizados por todo tipo de personas ya sea para mejorar su físico, <a className="links-big-body-builders" href="">ganar masa muscular</a>, <a className="links-big-body-builders">perder peso</a> o simplemente como complemento para todo tipo de deportes.
                        </p>
                        <p>
                        ...
                        <Row className="square-big-body-builders">
                            <p className="title-square-big-body-builders">Contenidos</p>
                            <ul>
                                <li className="li-square-big-body-builders">1 Los tres principios de la musculación</li>
