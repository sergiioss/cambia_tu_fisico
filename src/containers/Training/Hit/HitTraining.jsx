        ...
        <Row className="first-section-hit">
            <Col className="body-hit-training" xs={12} sm={12} md={8} lg={8} xl={8} xxl={8}>
                ...
                <section>
                    ...
                    <p>
                        En la actualidad, la práctica de la <strong>musculación</strong> es uno de los recursos más utilizados por todo tipo de personas ya sea para mejorar su físico, <a className="links-hit" href="">ganar masa muscular</a>, <a className="links-hit">perder peso</a> o simplemente como complemento para todo tipo de deportes.
                    </p>
                    <p>
                    ...
                    <Row className="square-hit">
                        ...
                        <ul>
                            <li className="li-square-hit">1 Los tres principios de la musculación</li>
