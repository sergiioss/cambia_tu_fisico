...
const HitTraining = () => {
    ...
    return (
        ...
        <Container className="hit-exercises-training">
        <Row className="first-section-hit">
        <Breadcrumb></Breadcrumb>
            <Col className="body-hit-training" xs={12} sm={12} md={8} lg={8} xl={8} xxl={8}>
                <h1>Entrenamiento de alta intensidad | Consejos y Técnicas</h1>
                <i>Con nuestros consejos y técnicas dominarás el arte de la musculación para cambiar tu cuerpo.</i>
                <Row className="icons-hit" xs={12} sm={12} md={9} lg={9} xl={9} xxl={9}>
                ...
                <section>
                    ...
                    <p>
                        Ahora ha llegado el momento de alcanzar un nuevo nivel de <strong>crecimiento muscular</strong> añadiendo <strong>técnicas culturistas avanzadas</strong> a tus rutinas de gimnasio.
                    </p>
                    <p>
                        <strong>Recuerda que en esta sección nos centramos en técnicas de alta intensidad pero tienes mucha más información sobre otra técnicas de entrenamiento en nuestra sección de musculación.</strong>
                    </p>
                    <Row className="square-hit">
                        <p className="title-square-hit">Contenidos</p>
                        <ul>
                            <li className="li-square-hit">1 Intensidad del entrenamiento</li>
                            <li>2 Intensidad y fallo muscular</li>
                            <li>3 Ventajas del entrenamiento de alta intensidad</li>
                            <li>4 Reglas para el entrenamiento de alta intensidad</li>
                            <li>5 Métodos para aumentar la intensidad de entrenamiento</li>
                            <li>6 Todas las técnicas de gimnasio de alta intensidad</li>
                            <li>7 No abuses de las técnicas de alta intensidad</li>
                        </ul>
                    </Row>
                    <h5>Intensidad del entrenamiento</h5>
                    <p>
                    ...
                    <h5>Intensidad y fallo muscular</h5>
                    <p>
                    ...
                    <h5>Ventajas del entrenamiento de alta intensidad</h5>
                    <p>
                    ...
                    <Image className="img-hit" src="https://www.cambiatufisico.com/wp-content/uploads/entrenamiento-avanzado.jpg"></Image>
                    <p>
                        Para ello es imprescindible una <strong>planificación</strong> de los entrenamientos, de los descansos, de las variaciones de los ejercicios, tener en cuenta los tiempos de ejecución, etc.
                    </p>
                    <p>
                        Utiliza estas técnicas en el gimnasio de forma planificada, sin abusar en exceso de ellas. En caso contrario puedes caer en el temido sobreentrenamiento o lo que es peor, en un <strong>estancamiento</strong> tanto anímico como físico que te impedirá alcanzar tus objetivos culturistas.
                    </p>
                    <p>
                    ...
                    <h3>Reglas para el entrenamiento de alta intensidad</h3>
                    <p>
                        Una típica serie de trabajo es prolongada y extenuante, pero aquí, cuando el <strong>músculo</strong> falla, la serie está justo empezando. Aquí van unos consejos para ayudarte a conseguir las recompensas del entrenamiento de alta intensidad.
                    </p>
                    <h5>Estrategia</h5>
                    <p>
