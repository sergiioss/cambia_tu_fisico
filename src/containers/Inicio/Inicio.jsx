    ...
    return (
        ...
        <Container className="inicio">
            ...
            <Row className="titles-section">
                <span className="title-section-words">RUTINAS DE GIMNASIO EFECTIVAS</span>
                <p>
            ...
            <Row className="titles-section">
                <span className="title-section-words">CONSIGUE TUS OBJETIVOS EN EL GIMNASIO</span>
                <p>
                    <strong>Ganar masa muscular:</strong><i>¿Quieres más músculos y dejar de ser el «chico delgado»?</i> Tenemos lo que necesitas para ganar músculo. 
                </p>
                <p>
                    <strong>Definición muscular:</strong><i>¿Tienes masa muscular pero no se marca lo suficiente? </i> Con nuestros consejos perderás la grasa que te sobra.
                </p>
            </Row>
            ...
            <Row className="titles-section">
                <span className="title-section-words">RUTINAS DE GIMNASIO POR GRUPO MUSCULAR</span>
                <p>
                    Tenemos las mejores <strong>rutinas de gimnasio</strong> por grupo muscular con ejercicios especializados para obtener los máximos resultados.
                </p>
                <p>
            ...
            <Row className="titles-section">
                <span className="title-section-words">DIETAS DE GIMNASIO PARA COMPLEMENTAR TUS RUTINAS</span>
                <p>
                    Nuestras <strong>rutinas</strong> son muy efectivas y están creadas siguiendo métodos científicos de entrenamiento pero necesitan ser complementadas con una dieta adecuada.
                </p>
                <p>
                    Una correcta alimentación es imprescindible para conseguir alcanzar tus metas y aquí tenemos las mejores <strong>dietas para ganar masa muscular</strong> y los mejores planes alimenticios para potenciar tu <strong>definición muscular.</strong>
                </p>
            </Row>
            <Row className="first-section">
                <Col className="third-image">
