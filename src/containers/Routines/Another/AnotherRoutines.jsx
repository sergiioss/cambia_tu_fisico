        ...
        <Container className="another-routine-training">
            <Row className="first-section-another-routine">
                <Col className="body-another-routine-training" xs={12} sm={12} md={8} lg={8} xl={8} xxl={8}>
                    ...
                    <br /> 
                    <Row className="icons-another-routine" xs={12} sm={12} md={9} lg={9} xl={9} xxl={9}>
                    ...
                    <Image className="img-another-routine" src="https://www.cambiatufisico.com/wp-content/uploads/pesas-otros-deportes-696x392.jpg"></Image>
                    <section>
                        <p>
                            Se puede aumentar el <strong>rendimiento físico</strong> en cualquier deporte a través de un <strong>entrenamiento sistemático</strong> de la fuerza.
                        </p>
                        <p>
                            El entrenamiento muscular complementario se orienta, por un lado, hacia los <strong>músculos</strong> especialmente solicitados en un deporte; estos músculos se han de entrenar entonces sistemáticamente para mejorar el rendimiento específico en este deporte.
                        </p>
                        <p>
                            Por otro lado, también es importante entrenar el cuerpo de forma <strong>armónica</strong> y compensar cargas <strong>desequilibradas</strong> – ante todo desde la perspectiva de la salud-; esto hace especial referencia a la musculatura del tronco y de la cintura escapular, que tiene como objetivo evitar <strong>sobrecargas</strong> para la espalda y las articulaciones.
                        </p>
                        <h3>Musculación para deportes individuales y colectivos</h3>
                        <p>
                            Los practicantes de actividades relacionadas con la musculación, muchas veces también son practicantes de otras actividades físicas, es por ello que citamos algunos consejos que ayudarían a a los que son <strong>multideportistas</strong>.
                        </p>
                        <p>
                            * Debemos en primer lugar <strong>separar las actividades físicas</strong> (deportivas) competitivas de las que visan sólo ocio; por ejemplo, separar un deporte que visa un campeonato (sea cuál sea) con el partido de fútbol de fin de semana que no visa aumento de rendimiento ni nada, solo de tener diversión.
                        </p>
                        <p>
                            * Es obvio y claro que los deportes que reciben un enfoque generarán un desgaste no tan solamente <strong>físico</strong> mayor, sino también <strong>psicológico</strong>; un jugador de fútbol o un luchador, por ejemplo, necesita de descansos adecuados, aliado a tipos de entrenamientos y alimentación específica; y, así, no hay diferencia con el culturismo o con la musculación estética o fitness que cuando se practica también requiere de un enfoque adecuado.
                        </p>
                        <p>
                        ...
                        <p>
                            * <strong>El enfoque</strong> por su parte, debe ser coherente entre ambos deportes; probablemente, nunca vimos ningún maratonista con 110 kg, no es lo mismo o un culturista espigado similar a un ciclista o un luchador de peso que practique actividades hechas por ejemplo para un nadador.
                        </p>
                        <p>
                            * <strong>Mantener la coherencia</strong> y saber que algunas limitaciones en algunos deportes son claras, evidentes y deben ser respetadas por mero factor físico y característico de cada deporte y/o modalidad es lo mínimo que debe ser respetado.
                        </p>
                        ...
                        <p>
                            La alimentación de un <strong>atleta de culturismo</strong> es totalmente diferente de los demás deportes; sin embargo, cuando el mismo practica otro deporte se hace aún más complicada, exigiendo niveles de energía aún mayores, relacionados a niveles proteicos suficientes para evitar no sólo la pérdida muscular, sino también mejor síntesis proteica.
                        </p>
                        <p>
                            La <strong>alimentación y suplementación</strong> estará condicionada por la posición de juego en que desarrolle su actividad. Aún así encontramos una serie de características comunes:
                        </p>
                        <p>
                        ...
                        <h5>Objetivos de la alimentación en deportes</h5>
                        <p>
                            – <strong>Mantener y/o desarrollar la masa muscular</strong>: aportando las necesidades de proteínas mínimas (entre 1’5 y 2 gr. por kilo. Los alimentos más adecuados son los de origen animal y al mismo tiempo con pocas grasas (carnes blancas y pescados. En ocasiones es difícil obtener la cantidad de proteína necesaria directamente de la dieta (140 gr. de proteína son 720 gr. de pollo) por lo que podemos acudir a los suplementos hidrolizados de proteínas.
                        </p>
                        <p>
                            – <strong>Aportar la energía necesaria</strong>: los hidratos de carbono son los que se encargan de reponer los depósitos de glucógeno, qué a su vez es la reserva de energía muscular para el rendimiento. Sin embargo, un exceso o elección errónea puede conllevar a un aumento de los depósitos de grasa. Apostaremos por carbohidratos de bajo índice glucémico: legumbres, yogures, hortalizas, cereales y evitaremos los de alto índice glucémico. Después del entrenamiento nos interesan alimentos con índice de moderado a alto. Al igual que ocurre con la proteína no siempre es fácil tener los alimentos necesarios a mano: podemos recurrir a batidos de carbohidratos y proteína.
                        </p>
                        <p>
                            – <strong>Conseguir un bajo porcentaje de grasa</strong>: Evitar alimentos con grasas saturadas, excesos de carbohidratos y calorías vacías (alcohol, azucares refinados).
                        </p>
                        <p>
                            Así pues:
                        </p>
                        <p>
                           <strong> Antes del entrenamiento</strong>: Evitaremos los alimentos sólidos puesto que su proceso de metabolización es lento. La ingesta de alimentos anterior al entrenamiento debe ser de fácil asimilación y realizada unas dos horas antes: fruta fresca, lácteos, sustitutos de comidas, barritas energéticas. Justo ante de entrenar podemos incluir aminoácidos ramificados y glutamina para evitar la degradación del tejido muscular.
                        </p>
                        <p>
                            <strong>Durante el entrenamiento</strong>: Si el entrenamiento es largo y de intensidad larga se puede incluir una bebida energética y/o isotónica con algo de carbohidratos de rápida asimilación, sales minerales y abundante agua, de esta forma evitaremos bajadas de los niveles de glucosa en sangre retardando la aparición de la fatiga.
                        </p>
                        <p>
                            <strong>Justo después del entrenamiento</strong>: aunque no tengas sed, bebe suficiente agua; 10 gr. de un combinado de creatina, taurina y glutamina; aminoácidos ramificados.
                        </p>
                        <h3>El descanso</h3>
                        <p>
                        ...
                        <p>
                            * <strong>Periodizar</strong>, como el propio nombre dice, significa trabajar con periodos, es decir, establecer focos dentro de cada modalidad en diferentes tiempos.
                        </p>
                        <p>
                        ...
                        <h3>Las pesas son útiles para cualquier deporte</h3>
                        <p>
                            <strong>Jugadores</strong> de tenis, de golf o de fútbol, casi todos los <strong>deportistas</strong> de rendimiento complementan la preparación para su deporte con el entrenamiento específico de la <strong>fuerza</strong>.
                        </p>
                        <p>
                            Por un lado, se aprovechan de una potenciación sistemática de la musculatura decisiva para su rendimiento.
                        </p>
                        <p>
                            Por otro, consiguen mediante una selección de ejercicios que las áreas musculares menos solicitadas se desarrollen proporcionalmente evitando o <strong>compensando</strong> de esta manera un desequilibrio muscular.
                        </p>
                        <p>
                        ...
                        <p>
                            Para incrementar el rendimiento se ofrecen los ejercicios que se <strong>aproximan a los movimientos de la</strong> <strong>modalidad deportiva</strong>, permitiendo un entrenamiento seguro incluso a intensidad elevada.
                        </p>
                        <p>
                            De esta manera se incrementará la <strong>fuerza máxima</strong> que a su vez mejora la <strong>fuerza explosiva</strong>.
                        </p>  
                        <h5>Fútbol</h5>
                        <p>
                            El entrenamiento de la fuerza de las piernas aumenta la potencia en los <strong>golpeos</strong> y en los <strong>saltos</strong>. La potenciación de tronco, hombros y brazos ofrece ventajas en el uno contra uno, giros de cabeza y saques de banda.
                        </p>
                    </section>
                </Col>
...
export default AnotherRoutines